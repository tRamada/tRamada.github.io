  ...
  return (
    <section id="home" className="hero">
      <div className="hero-text">
        ...
        <p className="intro">I focus on modern React, design systems, performance and clean, maintainable code. I enjoy turning complex problems into elegant interfaces.</p>
